...
import 'package:flutter_tennis_test/data/repositories_impl/precipitation_repository_impl.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        RepositoryProvider<PrecipitationRepository>(
          create: (context) => PrecipitationRepositoryImpl(
            precipitationDataApi: PrecipitationDataApi(),
          ),
        ),
